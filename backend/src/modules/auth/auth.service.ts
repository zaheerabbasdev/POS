...
export async function forgotPassword(email: string): Promise<void> {
  ...
  // No email provider is part of the documented tech stack yet, so the
  // "send reset link" step (SAD/API Spec) logs the token instead of mailing
  // it. Wire up a real transactional email send before shipping this.
